...
abstract class sfModelGeneratorHelper
{
  ...
  {
    return '<li class="sf_admin_action_save"><input class="'.$params["class"].'" type="submit" value="'.__($params['label'], array(), 'sf_admin').'" /></li>';
  }
  ...
  public function linkToSaveAndAdd($object, $params)
  {
    ...
    return '<li class="sf_admin_action_save_and_add"><input class="'.$params["class"].'" type="submit" value="'.__($params['label'], array(), 'sf_admin').'" name="_save_and_add" /></li>';
  }
}
